...
export const resetComments = (state, action) => state.merge({ list: [], offset: 0 });

// request the data from an api
export const getCommentsRequest = (state, action) => state.merge({ fetching: true });
...
// request the data from an api
export const postCommentRequest = (state, action) => state.merge({ posting: true });

// successful api lookup
export const postCommentSuccess = (state, action) => state.merge({
  posting: false,
});
